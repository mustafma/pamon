...
class ListViewBeds extends StatefulWidget {
    ...
    String roomId;
    final  parentAction;
    ListViewBeds({Key key, @required this.beds , this.parentAction, @required this.roomId});
        ...
        body: Center(
            ...
            if(snapshot.data == null){
              ...
              List item = [];
               ...
               snapshot.data.data['beds'].forEach((bed) => item.add(Bed.fromMap(bed,bed['bedId'])));//map((doc) => Bed.fromMap(doc.data, doc.documentID.toString())).toList();
